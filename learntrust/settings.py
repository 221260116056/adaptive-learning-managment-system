...
SECRET_KEY = 'django-insecure-6pbs#q^e4tp3y5r7h91)j&s-hs@dzi7lw4jr@@r6sm!=2*#qq*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'student.context_processors.notification_processor',
            ],
        },
    },
]
...
mimetypes.add_type("video/mp4", ".m4s", True)
