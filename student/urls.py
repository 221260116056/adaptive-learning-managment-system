...
urlpatterns = [
    ...
    path('theory/<int:module_id>/', views.video_player, name='theory_player'),
    path('quiz/<int:module_id>/', views.video_player, name='quiz_player'),
    path('assignment/<int:module_id>/', views.video_player, name='assignment_player'),
